            ...
            {showRestoreHint && cachedData && contentType === 'url' && (
              <div className="mx-3 mb-2 px-2.5 py-1.5 bg-[var(--color-bg)] border border-[var(--color-border)] rounded-lg">
                <div className="flex items-center gap-2">
                  ...
                  <p className="flex-1 min-w-0 text-xs text-[var(--color-text-secondary)] truncate"
                    title={restoreExpanded ? undefined : `${t('restore.title')}: ${cachedData.url}`}>
                    {t('restore.title')}
                    {!restoreExpanded && <span className="font-mono"> · {cachedData.url}</span>}
                  </p>
                ...
                {restoreExpanded && (
                  <div className="mt-1.5 pt-1.5 border-t border-[var(--color-border)]">
                    <p className="text-xs font-mono break-all select-all leading-relaxed text-[var(--color-text)]">{cachedData.url}</p>
                  </div>
                )}
              </div>
            )}
